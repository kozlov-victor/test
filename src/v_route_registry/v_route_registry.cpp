...
void VRouteRegistry::registerRoute(String url, String method, void (*handler)(VResponse*)) {
    VRouteRegistry::routes.add({url, method, handler});
}

boolean VRouteRegistry::handleRequest(String url, String method, VResponse* resp) {
